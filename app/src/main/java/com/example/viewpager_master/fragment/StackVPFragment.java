...
public class StackVPFragment extends Fragment {
    private static final String TAG = StackVPFragment.class.getSimpleName();
    ...
    public static StackVPFragment newInstance() {
        return new StackVPFragment();
    }
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        View view = inflater.inflate(R.layout.fragment_stack_vp, container, false);
